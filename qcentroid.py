...
# Import visualization module (separated for maintainability)
try:
    from visualizations import generate_quantum_visualizations
except ImportError:
    generate_quantum_visualizations = None
...
def run(
    ...
    if generate_quantum_visualizations is not None:
        generate_quantum_visualizations(
            history=history,
